...
The function `plot` produce a heatmap of the fragility and allows to visually check the correlation between the SOZ and sustained high fragility value. Time window around seizure onset [-1:2]s, which includes the following electrodes: 
...
`plotFragDistribution` and `plotFragQuantile` are similar to the `plot` function. They plot the fragility distribution and quantiles, respectively.
```{r, out.width="100%"}
